...
function getInitialData() {
  ...
  return {
    ...
    video: {
      url: "/assets/video/main-hero-video.mp4",
      poster: "/assets/images/main-hero-video-poster.jpg",
    ...
    products: [
      ...
      },
      {
        ...
        specifications: "microSDHC\nClass 10\nU3\nV30\nBuilt for security recording",
        product_video_url: "",
      ...
      },
      {
        ...
        specifications: "Plug-and-play USB\nFull-size design\n72% recycled plastic",
        product_video_url: "",
